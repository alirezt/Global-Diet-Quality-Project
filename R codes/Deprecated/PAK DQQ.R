...
### 3.24 At least one meat, pulse, or egg (for Pakistan) ----
d %<>% mutate(
  pak_mpe = case_when(DQQ4 == 0 & DQQ13 == 0 & DQQ16 == 0 & DQQ17 == 0 & DQQ18 == 0 & DQQ19 == 0 & DQQ20 == 0 & DQQ21 == 0 ~ 0L, 
                  DQQ4 == 1 | DQQ13 == 1 | DQQ16 == 1 | DQQ17 == 1 | DQQ18 == 1 | DQQ19 == 1 | DQQ20 == 1 | DQQ21 == 1 ~ 1L, TRUE ~ NA)
)
...
d$pak_all5 <- ifelse((
  case_when(d$DQQ1 == 0 & d$DQQ2 == 0 & d$DQQ3 == 0 ~ 0L, d$DQQ1 == 1 | d$DQQ2 == 1 | d$DQQ3 == 1 ~ 1L, TRUE ~ NA) +
    ...
    case_when(d$DQQ8 == 0 & d$DQQ9 == 0 & d$DQQ10_1 == 0 & d$DQQ10_2 == 0 & d$DQQ10_3 == 0 ~ 0L, 
              d$DQQ8 == 1 | d$DQQ9 == 1 | d$DQQ10_1 == 1 | d$DQQ10_2 == 1 | d$DQQ10_3 == 1 ~ 1L, TRUE ~ NA) + 
    case_when(d$DQQ14 == 0 & d$DQQ15 == 0 & d$DQQ25 == 0 ~ 0L, d$DQQ14 == 1 | d$DQQ15 == 1 | d$DQQ25 == 1 ~ 1L, TRUE ~ NA) +
    case_when(d$DQQ4 == 0 & d$DQQ13 == 0 & d$DQQ16 == 0 & d$DQQ17 == 0 & d$DQQ18 == 0 & d$DQQ19 == 0 & d$DQQ20 == 0 & d$DQQ21 == 0 ~ 0L, 
              d$DQQ4 == 1 | d$DQQ13 == 1 | d$DQQ16 == 1 | d$DQQ17 == 1 | d$DQQ18 == 1 | d$DQQ19 == 1 | d$DQQ20 == 1 | d$DQQ21 == 1 ~ 1L, TRUE ~ NA)) == 5, 1, 0)
...
for (j in unique(d$YEAR)){
  ...
  for(k in unique(dd$Country)){
    ...
    for(i in c("all5", "all5a", "all5b", "all5c", "all5d", "all5e", "DQQ11", "DQQ14", "DQQ9", "dairy", "dveg", "DQQ24", "DQQ13", 
               ...
               "DQQ8", "DQQ5", "DQQ3", "DQQ2", "DQQ15", "zvegfr", "pak_mpe", "pak_all5")){ 
      # All
...
longNames <- c(all5 = "All-5", 
               ...
               pak_all5 = "All-5-Pakistan",
               pak_mpe = "At least one meat, pulse, or egg"
...
write_csv(results, "DQQ_GWP_2021-2022_14Feb2024.csv")
