######## DQQ-based Indicators for 2021 and 2022 (un-merged version) ######
...
result1 <- setNames(data.frame(matrix(ncol = 10, nrow = 1)), c("Income_group", "Region", "Country", "ISO3", "Subgroup", "Variable", "Year", "Mean_Prevalence", "LCI", "UCI"))
result2 <- setNames(data.frame(matrix(ncol = 10, nrow = 1)), c("Income_group", "Region", "Country", "ISO3", "Subgroup", "Variable", "Year", "Mean_Prevalence", "LCI", "UCI"))
