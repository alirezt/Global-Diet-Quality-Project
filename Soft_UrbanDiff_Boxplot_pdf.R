...
data_brief <- dat_agg %>%
  filter(Indicator == "Soft drink consumption" & Subgroup == "Urban" &
...
data_brief %>%
  ...
  labs(x = "", y = "Percentage point difference in prevalence<br>soft drink consumption") +
  theme(
...
ggsave(file = "Data/Output/Graphs/pdf/Soft drink_urban-rural_GWP2021-2022.pdf", dpi = 96,
