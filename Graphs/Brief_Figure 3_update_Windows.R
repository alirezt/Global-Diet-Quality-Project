...
figure3 <- figure3(df = df1, dfline = linesdata ,  Country_name = "United States 2022", year = 2022)
...
ncdrGraph <- function(Country_name, year){
  ...
  ggplot(ncdr_bind, aes(x = Indicator, y = mean_pre, fill = stack)) + 
    ...
    annotate("text", x = -2, y = 0, size = 4, family =  "Whitney", hjust = 0, lineheight = .95, fontface = "italic",
...
NCDR <- ncdrGraph(Country_name = "United States 2022", year = 2022)

# 6. Combined Graphs ----
Brief <- plot_grid(figure3, NCDR, rel_heights = c(1, 0.1), nrow = 2, ncol = 1)
ggsave(file = "Data/Output/Graphs/United States 2022 Graph 3.pdf", 
