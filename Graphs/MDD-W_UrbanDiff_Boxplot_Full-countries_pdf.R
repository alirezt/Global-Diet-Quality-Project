...
data_file <- "DQQ_GWP_2021-2022_2023_Public_10April2024.csv"
...
ggsave(file = "Data/Output/Graphs/pdf/test.pdf", dpi = 96,
       width = 12,  height = 22.8, units ='in', device = cairo_pdf)
